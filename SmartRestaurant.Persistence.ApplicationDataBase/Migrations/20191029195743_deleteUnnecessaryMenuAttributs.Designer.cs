...
namespace SmartRestaurant.Persistence.ApplicationDataBase.Migrations
{
    ...
    [Migration("20191029195743_deleteUnnecessaryMenuAttributs")]
    partial class deleteUnnecessaryMenuAttributs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Commun.Language", b =>
                {
                    ...
                    b.Property<string>("SelectLanguage");
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Pricings.Tarification", b =>
                {
                    ...
                    b.Property<System.DateTime>("From");
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Restaurants.Owner", b =>
                {
                    ...
                    b.Property<System.DateTime>("DateOfBirth");
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Services.ServiceState", b =>
                {
                    b.Property<Guid>("ServiceId");

                    b.Property<int>("State");

                    b.Property<System.DateTime>("SysDate");

                    b.HasKey("ServiceId", "State");
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Commun.Gallery", b =>
                {
                    ...
                    b.HasOne("SmartRestaurant.Domain.Restaurants.MenuItem", "MenuItem")
                        .WithOne("Gallery")
                        .HasForeignKey("SmartRestaurant.Domain.Commun.Gallery", "MenuItemId");
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Dishes.DishEquivalence", b =>
                {
                    ...
                    b.OwnsOne("SmartRestaurant.Domain.Commun.Quantity", "QuantityEquivalence", b1 =>
                        {
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Restaurants.Menu", b =>
                {
                    ...
                    b.HasOne("SmartRestaurant.Domain.Restaurants.Staff")
                        .WithMany("Menus")
                        .HasForeignKey("StaffId");
                });
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Restaurants.MenuItem", b =>
                {
                    ...
                    b.OwnsOne("SmartRestaurant.Domain.Commun.Price", "Discount", b1 =>
                        {
                            ...
                            b1.HasOne("SmartRestaurant.Domain.Restaurants.MenuItem")
                                .WithOne("Discount")
                                .HasForeignKey("SmartRestaurant.Domain.Commun.Price", "MenuItemId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
                    ...
                    b.OwnsOne("SmartRestaurant.Domain.Commun.ServiceDateTime", "DateService", b1 =>
                        {
                            ...
                            b1.Property<System.DateTime>("Date");
