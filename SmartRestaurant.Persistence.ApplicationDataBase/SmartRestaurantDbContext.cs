...
namespace SmartRestaurant.Persistence.ApplicationDataBase
{
    public class SmartRestaurantDbContext : DbContext, ISmartRestaurantDatabaseService
    {
        ...
        private string strConnection = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=SRdb;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
       ...
       // private string strConnection = "Data Source=SQL5002.site4now.net;Initial Catalog=DB_A4A1E4_SRDB;User Id=DB_A4A1E4_SRDB_admin;Password=g2242019;";
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Mailing>(new MailingConfiguration().Configure);
