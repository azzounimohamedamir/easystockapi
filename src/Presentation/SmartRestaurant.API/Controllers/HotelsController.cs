...
namespace SmartRestaurant.API.Controllers
{
    ...
    public class HotelsController : ApiController
    {
        ...
        [HttpGet]
        [Authorize(Roles = "FoodBusinessManager,SupportAgent,SuperAdmin,HotelServiceAdmin,HotelServiceTechnique,HouseKeeping")]
        ...
        /// <summary> GetListOfHotelsByHotelReceptionist() </summary>
        /// <remarks>This endpoint allows us to fetch list of hotels of Current Receptionist </remarks>
        /// <response code="200"> hotels list has been successfully fetched.<br></br><b>Note:</b> Picture will be encoded in Base64</response>
        /// <response code="400">The payload data sent to the backend-server in order to fetch hotels list is invalid.</response>
        /// <response code="401">The cause of 401 error is one of two reasons: Either the user is not logged into the application or authentication token is invalid or expired.</response>
        /// <response code="403"> The user account you used to log into the application, does not have the necessary privileges to execute this request.</response>

        [Route("byreceptionistlist")]
        [HttpGet]
        [Authorize(Roles = "HotelReceptionist")]
        public Task<IActionResult> GetAllHotelsByHotelReceptionist()
        {
            return SendWithErrorsHandlingAsync(new GetAllHotelsByHotelReceptionistQuery());
        }
       ...
       [Authorize(Roles = "FoodBusinessAdministrator")]
        ...
        [Route("{id:Guid}")]
        [HttpGet]
        [Authorize(Roles = "FoodBusinessAdministrator,FoodBusinessManager,FoodBusinessOwner,SupportAgent,SuperAdmin,Diner,Organization,Waiter,HotelClient,HotelServiceAdmin,HotelServiceTechnique,HouseKeeping")]
