...
namespace SmartRestaurant.API.Controllers
{
    ...
    public class OrdersController : ApiController
    {
        ...
        [Route("{id}")]
        [HttpPut]
        [Authorize(Roles = "FoodBusinessManager, Cashier,Waiter,Diner")]
        ...
        /// <summary> GetListOfOrdersOfDinerOrClientHotel() </summary>
        ...
        [ProducesResponseType(typeof(ExceptionResponse), 400)]
        [Authorize(Roles = "HotelClient,Diner,FoodBusinessManager,HotelServiceAdmin,FoodBusinessAdministrator")]
        ...
        [Route("TotalSHClientOrders")]
        [HttpGet]
        public Task<IActionResult> GetTotalOfOrdersSHByHotel(string currentFilter, string searchKey, string sortOrder,
            int page, int pageSize, DateFilter dateInterval, string hotelId, string orderDestinationId)
        {
            var query = new GetAllClientSHOrdersTotalQuery
            {
                CurrentFilter = currentFilter,
                SearchKey = searchKey,
                SortOrder = sortOrder,
        ...
        /// <summary> GetTodayListOfOrdersOfDinerByTableId() </summary>
        /// <remarks>This endpoint allows us to fetch list of orders of current Diner or Client Hotel.</remarks>
        /// <param name="currentFilter">Orders list can be filtred by: <b>order number</b></param>
        /// <param name="searchKey">Search keyword</param>
        /// <param name="sortOrder">Orders list can be sorted by: <b>acs</b> | <b>desc</b>. Default value is: <b>acs</b></param>
