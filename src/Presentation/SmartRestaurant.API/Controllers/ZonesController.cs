...
namespace SmartRestaurant.API.Controllers
{
    ...
    public class ZonesController : ApiController
    {
        ...
        /// <summary> GetZoneListWithNumberOfOrders() </summary>
        /// <remarks>This endpoint allows <b>restaurant manager</b> and <b>Support Agent</b> to fetch the liste of zones with number of  Orders.</remarks>
        /// <param name="id">id of the Food Buisines that would be used to fetch zone</param>
        /// <response code="200"> the liste of Zone with tables has been successfully fetched.</response>
        /// <response code="400">The payload data sent to the backend-server in order to fetch the liste of zones is invalid.</response>
        /// <response code="401">The cause of 401 error is one of two reasons: Either the user is not logged into the application or authentication token is invalid or expired.</response>
        /// <response code="403"> The user account you used to log into the application, does not have the necessary privileges to execute this request.</response>
