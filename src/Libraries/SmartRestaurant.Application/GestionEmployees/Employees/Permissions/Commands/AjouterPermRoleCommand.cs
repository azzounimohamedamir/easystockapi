...
{
    public class AjouterPermRoleCommand : CreateCommand
    {
    ...
    public class AjouterPermRoleCommandValidator : AbstractValidator<AjouterPermRoleCommand>
    {
        public AjouterPermRoleCommandValidator()
        {
