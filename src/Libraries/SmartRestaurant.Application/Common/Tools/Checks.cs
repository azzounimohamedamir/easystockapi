...
namespace SmartRestaurant.Application.Common.Tools
{
    public class Checks
    {
        ...
        public static async Task CheckQuery_ThrowExceptionIfQueryIsInvalid<Validator, Request>(Request request, CancellationToken cancellationToken) where Validator : AbstractValidator<Request>, new()
        {
