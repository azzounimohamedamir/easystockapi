...
namespace SmartRestaurant.Persistence.ApplicationDataBase.Migrations
{
    ...
    [Migration("20190515112842_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Commun.Specialty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Dishes.Ingredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Pricings.Pricing", b =>
                {
                    ...
                    b.Property<decimal>("TarificationAmount");
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Dishes.DishAccompanying", b =>
                {
                    ...
                    b.OwnsOne("SmartRestaurant.Domain.Commun.Quantity", "Quantity", b1 =>
                        {
                            b1.Property<Guid>("DishAccompanyingId");

                            b1.Property<Guid>("UnitId");

                            b1.Property<decimal>("Value");

                            b1.HasKey("DishAccompanyingId");
                            ...
                            b1.HasOne("SmartRestaurant.Domain.Dishes.DishAccompanying")
                                .WithOne("Quantity")
                                .HasForeignKey("SmartRestaurant.Domain.Commun.Quantity", "DishAccompanyingId")
                                .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Dishes.DishIngredient", b =>
                {
                    ...
                    b.HasOne("SmartRestaurant.Domain.Dishes.Ingredient", "Ingredient")
                        .WithMany("Ingredients")
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Foods.Food", b =>
                {
                    ...
                    b.HasOne("SmartRestaurant.Domain.Dishes.Ingredient")
                        .WithMany("Foods")
                        .HasForeignKey("IngredientId");
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Pricings.Pricing", b =>
                {
                    ...
                    b.OwnsOne("SmartRestaurant.Domain.Commun.Price", "SalePrice", b1 =>
                        {
            ...
            modelBuilder.Entity("SmartRestaurant.Domain.Restaurants.RestaurantSpecialty", b =>
                {
                    b.HasOne("SmartRestaurant.Domain.Commun.Specialty", "Specialty")
