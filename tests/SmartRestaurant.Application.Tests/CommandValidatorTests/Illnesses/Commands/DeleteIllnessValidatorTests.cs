...
{
    public class DeleteIllnessCommandValidatorTests
    {
        private readonly DeleteIllnessCommandValidator _validator;

        public DeleteIllnessCommandValidatorTests()
        {
            _validator = new DeleteIllnessCommandValidator();
        }
