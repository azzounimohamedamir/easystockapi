...
namespace SmartRestaurant.Application.Tests.CommandValidatorTests.Dishes.Queries
{
    public class GetDishListQueryValidatorTests
    {
        private readonly GetDishesListQueryValidator _validator;

        public GetDishListQueryValidatorTests()
        {
            _validator = new GetDishesListQueryValidator();
        }
