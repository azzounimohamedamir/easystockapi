...
{
    public class GetDishByIdQueryValidatorTests
    {
        private readonly GetDishByIdQueryValidator _validator;

        public GetDishByIdQueryValidatorTests()
        {
            _validator = new GetDishByIdQueryValidator();
        }
