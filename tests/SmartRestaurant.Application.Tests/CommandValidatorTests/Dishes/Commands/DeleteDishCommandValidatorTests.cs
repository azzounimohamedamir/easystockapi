...
{
    public class DeleteDishCommandValidatorTests
    {
        private readonly DeleteDishCommandValidator _validator;

        public DeleteDishCommandValidatorTests()
        {
            _validator = new DeleteDishCommandValidator();
        }
