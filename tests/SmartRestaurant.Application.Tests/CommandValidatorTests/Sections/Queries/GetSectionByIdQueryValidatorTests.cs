...
{
    public class GetSectionByIdQueryValidatorTests
    {
        private readonly GetSectionByIdQueryValidator _validator;

        public GetSectionByIdQueryValidatorTests()
        {
            _validator = new GetSectionByIdQueryValidator();
        }
