...
{
    public class RemoveProductFromSectionCommandValidatorTests
    {
        private readonly RemoveProductFromSectionCommandValidator _validator;

        public RemoveProductFromSectionCommandValidatorTests()
        {
            _validator = new RemoveProductFromSectionCommandValidator();
        }
