...
{
    public class AddDishToSectionCommandValidatorTests
    {
        private readonly AddDishToSectionCommandValidator _validator;

        public AddDishToSectionCommandValidatorTests()
        {
            _validator = new AddDishToSectionCommandValidator();
        }
