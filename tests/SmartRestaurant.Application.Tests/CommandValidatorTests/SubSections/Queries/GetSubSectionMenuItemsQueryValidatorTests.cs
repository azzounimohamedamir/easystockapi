...
{
    public class GetSubSectionMenuItemsQueryValidatorTests
    {
        private readonly GetSubSectionMenuItemsQueryValidator _validator;

        public GetSubSectionMenuItemsQueryValidatorTests()
        {
            _validator = new GetSubSectionMenuItemsQueryValidator();
        }
