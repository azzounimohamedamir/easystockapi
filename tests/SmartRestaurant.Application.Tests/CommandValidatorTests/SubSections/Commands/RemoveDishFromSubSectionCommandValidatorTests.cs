...
{
    public class RemoveDishFromSubSectionCommandValidatorTests
    {
        private readonly RemoveDishFromSubSectionCommandValidator _validator;

        public RemoveDishFromSubSectionCommandValidatorTests()
        {
            _validator = new RemoveDishFromSubSectionCommandValidator();
        }
