...
{
    public class AddProductToSubSectionCommandValidatorTests
    {
        private readonly AddProductToSubSectionCommandValidator _validator;

        public AddProductToSubSectionCommandValidatorTests()
        {
            _validator = new AddProductToSubSectionCommandValidator();
        }
