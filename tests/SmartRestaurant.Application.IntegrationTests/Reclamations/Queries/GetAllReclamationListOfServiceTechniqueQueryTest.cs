...
namespace SmartRestaurant.Application.IntegrationTests.Reclamations.Queries
{
    ...
    public class GetAllReclamationListOfServiceTechniqueQueryTest : TestBase
    {
        [Test]
        public async Task ShouldGetAllReclamationListOfServiceTechniqueTestShouldHaveBothOfHotelsreclamations()
        {
            ...
            var query = new GetAllReclamationListOfServiceTechniqueQuery
            {
