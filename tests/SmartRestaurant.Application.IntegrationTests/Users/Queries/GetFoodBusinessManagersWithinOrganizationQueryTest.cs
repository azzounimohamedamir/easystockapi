...
namespace SmartRestaurant.Application.IntegrationTests.Users.Queries
{
    ...
    public class GetFoodBusinessManagersWithinOrganizationQueryTest : TestBase
    {
        ...
        public async Task ShouldGetFoodBusinessManagers()
        {
            ...
            var organization_02_foodBusinessAdministrator = await CreateFoodBusinessAdministratorUser(organization_02_fastFood.FoodBusinessAdministratorId);
        ...
        private static async Task<ApplicationUser> CreateFoodBusinessAdministratorUser(string foodBusinessAdministratorId)
        {
