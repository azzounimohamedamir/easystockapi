...
namespace SmartRestaurant.Application.IntegrationTests.Orders.Commands
{
	...
	[TestFixture]
	public class CreateOrderWithOdooTest : TestBase
	{
		[Test]
		public async Task CreateOrderWithOdoo_ShouldSaveToDB()
		{
			await RolesTestTools.CreateRoles();
			var foodBusinessAdministrator = await UsersTestTools.CreateFoodBusinessAdministrator();
			var odoo= new OdooDto
				{
					Db="odooDb",
			...
			var fastFood = await FoodBusinessTestTools.CreateFoodBusiness(foodBusinessAdministrator.Id,odoo);
