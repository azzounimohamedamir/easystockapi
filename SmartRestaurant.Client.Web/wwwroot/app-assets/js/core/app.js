...
(function(window, document, $) {
    ...
    $(window).on('load',function(){
        ...
        // Collapsible Card By Id ghassan
        $('a[data-action="collapse2"]').on('click', function (e) {
            e.preventDefault();
            var target = $($(this).data("target"));//card
            target.children('.card-body').collapse('toggle');
            target.find('[data-action="collapse2"] i').toggleClass('icon-minus4 icon-plus4');
        });
