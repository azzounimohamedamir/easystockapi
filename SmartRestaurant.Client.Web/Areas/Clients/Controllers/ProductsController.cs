...
namespace SmartRestaurant.Client.Web.Areas.Clients.Controllers
{
    ...
    {
        private readonly ILoggerService<ProductsController> log;
        ...
        public ProductsController(IConfiguration configuration,
                                         ...
                                         ILoggerService<ProductsController> log) : base(configuration, mailing, notify, baselog, getRetaurantBySlugUrlQuery)
        {
