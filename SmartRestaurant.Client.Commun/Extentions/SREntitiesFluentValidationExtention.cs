...
{
    public static class SREntitiesFluentValidation
    {
        public static IServiceCollection AddSREntitiesFluentValidation(this IServiceCollection services)
        {
            //Class by Ahmed
            ...
            services.AddTransient<IValidator<MenuModel>, CreateMenuValidator>();
            ...
            services.AddTransient<IValidator<UpdateTranslateModel>, UpdateTranslateCommandValidation>();
            services.AddTransient<IValidator<CreateTranslateModel>, CreateTranslateCommandValidation>();
            ...
            services.AddTransient<IValidator<CreateDishModel>, CreateDishModelValidation>();
            services.AddTransient<IValidator<IDishModel>, DishModelValidation>();
            services.AddTransient<IValidator<DishModel>, DishModelValidation>();

            services.AddTransient<IValidator<DishIngredientModel>, DishIngredientModelValidation>();
            services.AddTransient<IValidator<IDishIngredientModel>, DishIngredientModelValidation>();
            ...
            #region Galleries
            services.AddTransient<IValidator<IGalleryModel>, GalleryModelValidation>();
            services.AddTransient<IValidator<GalleryModel>, GalleryModelValidation>();
            services.AddTransient<IValidator<IGalleryPictureModel>, GalleryPictureValidation>();
            services.AddTransient<IValidator<GalleryPictureModel>, GalleryPictureValidation>();
            #endregion
